...
" "
" " For a specific filetype highlighting rules issue :syntax list when a file
" of
" " that type is opened.
"
" " Initialization {{{
...
"   echomsg ""
  ...
  if exists("syntax_on")
    ...
    " TODO
    " " hi MoreMsg
    " hi NonText      ctermfg=247 guifg=#9e9e9e ctermbg=233 guibg=#121212
    " cterm=bold gui=bold
    ...
    " hi SpellBad     ctermfg=160 guifg=fg      ctermbg=bg
    " cterm=underline               guisp=#df0000
    " hi SpellCap     ctermfg=189 guifg=#dfdfff ctermbg=bg  guibg=bg
    " cterm=underline gui=underline
    " hi SpellRare    ctermfg=168 guifg=#df5f87 ctermbg=bg  guibg=bg
    " cterm=underline gui=underline
    " hi SpellLocal   ctermfg=98  guifg=#875fdf ctermbg=bg  guibg=bg
    " cterm=underline gui=underline
    " hi StatusLine   ctermfg=15  guifg=#ffffff ctermbg=239 guibg=#4e4e4e
    " cterm=bold gui=bold
    " hi StatusLineNC ctermfg=249 guifg=#b2b2b2 ctermbg=237 guibg=#3a3a3a
    " cterm=none gui=none
    ...
    " cterm=none gui=none
    " " hi VIsualNOS    ctermfg=24  guifg=#005f87 ctermbg=153 guibg=#afdfff
    " cterm=none gui=none
